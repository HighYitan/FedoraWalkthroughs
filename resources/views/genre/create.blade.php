                    ...
                    <form action="{{ route('genre.store') }}" method="post">
                        ...
                        @foreach ($idiomas as $i => $idioma)
                            <div class="mb-3">
                                ...
                                <div class="mb-2">
                                    <label>Nombre</label>
                                    <input type="text" class="mt-1 block w-full" name="traducciones[{{ $i }}][nombre]" style="@error('traducciones[{{ $i }}][nombre]') border-color:RED; @enderror" />
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="mt-1 block w-full" name="traducciones[{{ $i }}][descripcion]" minlength="6" maxlength="1000" style="@error('traducciones[{{ $i }}][descripcion]') border-color:RED; @enderror"></textarea>
