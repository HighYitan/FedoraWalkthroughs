        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('gameRelease.store') }}" method="post">
                        @csrf  <!-- Security Token -->
                        <div class="mb-3">
                            ...
                            <select name="nombre_inicial" class="mt-1 block w-full mb-1">
                                ...
                                @foreach ($games as $game)
                                    <option value="{{ $game['nombre_inicial'] }}">
                                        {{ $game['nombre_inicial'] }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="mt-1 block w-full" style="@error('lanzamiento') border-color:RED; @enderror" name="lanzamiento" />
                        ...
                        <div class="mb-3">
                            ...
                            <select name="region" class="mt-1 block w-full mb-1">
                                ...
                                @foreach ($regions as $region)
                                    <option value="{{ $region['nombre_inicial'] }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="plataformas-container">
                                @php
                                    $oldPlataformas = old('plataformas', [['plataforma' => '']]);
                                @endphp
                        ...
                        <div class="mb-3">
                            ...
                            <div id="desarrolladores-container">
                                @php
                                    $oldDesarrolladores = old('desarrolladores', [['nombre' => '']]);
                                @endphp
                        ...
                        <div class="mb-3">
                            ...
                            <div id="distribuidores-container">
                                @php
                                    $oldDistribuidores = old('distribuidores', [['nombre' => '']]);
                                @endphp
