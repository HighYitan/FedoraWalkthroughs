                    ...
                    <form action="{{ route('news.store') }}" method="post">
                        ...
                        @foreach ($idiomas as $i => $idioma)
                            <div class="mb-3">
                                ...
                                <div class="mb-2">
                                    <label>Título</label>
                                    <input type="text" class="mt-1 block w-full" name="traducciones[{{ $i }}][titulo]" style="@error('traducciones[{{ $i }}][titulo]') border-color:RED; @enderror" />
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="mt-1 block w-full" name="traducciones[{{ $i }}][contenido]" minlength="6" maxlength="10000" style="@error('traducciones[{{ $i }}][contenido]') border-color:RED; @enderror"></textarea>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="mt-1 block w-full" name="traducciones[{{ $i }}][imagen]" style="@error('traducciones[{{ $i }}][imagen]') border-color:RED; @enderror" />
